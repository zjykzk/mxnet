...
def get_resnet152_train(num_classes=config.NUM_CLASSES, num_anchors=config.NUM_ANCHORS):
...
def get_resnet152_test(num_classes=config.NUM_CLASSES, num_anchors=config.NUM_ANCHORS):
    data = mx.symbol.Variable(name="data")
    im_info = mx.symbol.Variable(name="im_info")
