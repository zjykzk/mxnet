...
def proposal(network, dataset, image_set, root_path, dataset_path,
             ctx, prefix, epoch,
             vis, shuffle, thresh):
    ...
    # start testing
    generate_proposals(predictor, test_data, imdb, vis=vis, thresh=thresh)
...
def main():
    ...
    ctx = mx.gpu(args.gpu)
    proposal(args.network, args.dataset, args.image_set, args.root_path, args.dataset_path,
